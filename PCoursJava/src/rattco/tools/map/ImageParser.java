...
public class ImageParser
	...
	public static LvlMap getMapFromFolder(String folderName)
		...
		try
			{
			return getMap(ImageIO.read(new File(folderName + "/map.png")), ImageIO.read(new File(folderName + "/maptexture.png")));
			}
		catch (IOException e)
			{
			e.printStackTrace();
	...
	public static LvlMap getMap(String mapName)
		...
		try
			{
			return getMap(ImageIO.read(new File("sprite/map/" + mapName + ".png")), ImageIO.read(new File("sprite/map/" + mapName + "texture.png")));
			}
		catch (IOException e)
			{
			e.printStackTrace();
